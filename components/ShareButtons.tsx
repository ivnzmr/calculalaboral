...
export default function ShareButtons({ title }: { title: string }) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      <span className="text-xs text-slate-500 font-medium">Compartir:</span>
      <a
      ...
      >
        {copied ? (
          <>
            <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-current text-green-600" aria-hidden="true">
